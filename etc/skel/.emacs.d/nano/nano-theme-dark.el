...
;;修改以下这些颜色就是改变主要的theme颜色
;;我比较喜欢这个theme，https://github.com/morhetz/gruvbox
(defun nano-theme-set-dark ()
  ...
  ;;#ECEFF4
  ;;主要文字颜色
  (setq nano-color-foreground "#FED6AE") ;; Snow Storm 3  / nord  6
  ;;(setq nano-color-background "#2E3440") ;; Polar Night 0 / nord  0
  ;;背景颜色
  (setq nano-color-background "#262626")
